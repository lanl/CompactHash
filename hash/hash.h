...
//
#define HASH_NUM_HASHES /**/ 8
#define HASH_NUM_CL_HASHES /**/ 4
//
#define LCG_QUADRATIC_OPEN_COMPACT_HASH_ID 128
#define LCG_QUADRATIC_OPEN_COMPACT_CL_HASH_ID 8
#define LCG_LINEAR_OPEN_COMPACT_HASH_ID 64
#define LCG_LINEAR_OPEN_COMPACT_CL_HASH_ID 4
#define IDENTITY_SENTINEL_PERFECT_HASH_ID 32
#define IDENTITY_SENTINEL_PERFECT_CL_HASH_ID 2
#define IDENTITY_PERFECT_HASH_ID 16
 ...
 */
#define HASH_ALL_HASHES (HASH_ALL_CL_HASHES | HASH_ALL_C_HASHES)
/**
 * HASH_NOSENTINEL_PERFECT_HASHES perfect hash table types that do not use a sentinel value to mark empty buckets.
 */
#define HASH_NOSENTINEL_PERFECT_HASHES (IDENTITY_PERFECT_HASH_ID | IDENTITY_PERFECT_CL_HASH_ID)
/**
 * HASH_SENTINEL_PERFECT_HASHES perfect hash table types that use a sentinel value to mark empty buckets.
 */
#define HASH_SENTINEL_PERFECT_HASHES (IDENTITY_SENTINEL_PERFECT_HASH_ID | IDENTITY_SENTINEL_PERFECT_CL_HASH_ID)
/**
 ...
 */
#define HASH_QUADRATIC_COMPACT_HASHES (LCG_QUADRATIC_OPEN_COMPACT_HASH_ID | LCG_QUADRATIC_OPEN_COMPACT_CL_HASH_ID)
/**
 * HASH_LINEAR_COMPACT_HASHES compact hash table types that use a linear probe sequence.
 */
#define HASH_LINEAR_COMPACT_HASHES (LCG_LINEAR_OPEN_COMPACT_HASH_ID | LCG_LINEAR_OPEN_COMPACT_CL_HASH_ID)
/**
